    ...
    <main className="min-h-screen">
      ...
      {loading ? (
        ...
        <div id="cursos-list">
          ...
          <section id="turismo" className="course-section" style={{ background: 'var(--color-background)', position: 'relative', overflow: 'hidden', padding: 'clamp(3rem, 5vw, 6rem) 0' }}>
            <div className="container" style={{ position: 'relative', zIndex: 1 }}>
              <ScrollReveal>
          ...
          <section className="course-section" style={{ color: 'white', position: 'relative', overflow: 'hidden', padding: 'clamp(3rem, 5vw, 6rem) 0' }}>
            <div
              style={{
                position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, zIndex: 0,
          ...
          <section className="course-section" style={{ background: 'var(--color-background)', overflow: 'hidden', padding: 'clamp(3rem, 5vw, 6rem) 0' }}>
